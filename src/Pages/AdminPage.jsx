    ...
    return (
        <div className="bg-gray-900 flex flex-col items-center justify-start min-h-screen p-5">
            ...
            <div className="flex space-x-6 my-4">
                <div className="w-8 h-8 bg-black-600 p-2 rounded-full border-4" onClick={() => handleColor(0)}></div>
                <div className="w-8 h-8 bg-red-600 p-2 rounded-full border-4" onClick={() => handleColor(1)}></div>
                <div className="w-8 h-8 bg-yellow-600 p-2 rounded-full border-4" onClick={() => handleColor(2)}></div>
                <div className="w-8 h-8 bg-green-600 p-2 rounded-full border-4" onClick={() => handleColor(3)}></div>
            </div>
            <div className="text-white">Total number of responses: {count}</div>
