    ...
    <div className='flex flex-col min-h-screen justify-center items-center bg-gray-900 text-gray-300 text-9xl font-anton'>
      ...
      <div className='-rotate-12'>
        <Marquee className=' hover:animate-wiggle'>
          <div><DotLottieReact src="https://lottie.host/2c5752eb-1858-49e2-8b10-4c67d4a17fc0/VBWqaypUCK.lottie" loop autoplay/></div>
          <div><DotLottieReact src="https://lottie.host/0717c223-89b2-4b19-9148-c78298d75039/sWA3NktCm0.lottie" loop autoplay/></div>
